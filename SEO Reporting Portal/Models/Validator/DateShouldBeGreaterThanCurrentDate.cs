...
{
    public class DateShouldBeGreaterThanCurrentDate : ValidationAttribute
    {
        protected override ValidationResult IsValid(object value, ValidationContext validationContext)
        {
            ...
            var result = DateTime.Compare(user.ContractStartDate.Value, DateTime.Today);
            ...
            {
                return new ValidationResult("Contract Start Date should be greater than today's date");
            }
